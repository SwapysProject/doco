...
export default function SettingsPage() {
  ...
  const [profileData, setProfileData] = useState({
    ...
    email: 'john.smith@doctorcare.com',
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-muted-foreground mb-2">Specialty</label>
                  <select
                ...
                <div>
                  <label className="block text-sm font-medium text-muted-foreground mb-2">License Number</label>
                  <input
                    type="text"
                  ...
                  <div key={key} className="flex items-center justify-between py-3 border-b border-border">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">
                        ...
                        {key === 'criticalAlerts' && 'Receive immediate alerts for critical patients'}
                        {key === 'patientUpdates' && 'Updates on patient condition changes'}
                    ...
                    >
                      <span
                        className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${notifications[key as keyof typeof notifications]
                            ? 'translate-x-6'
                            : 'translate-x-1'
                          }`}
                      />
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
                  ...
                  <button
                    key={theme.id}
                    className={`p-4 border-2 rounded-lg transition-all ${theme.id === 'light'
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-4">
                <div className="bg-card border border-border rounded-lg p-4">
                  <h4 className="font-medium text-foreground mb-2">Export Patient Data</h4>
                  <p className="text-sm text-muted-foreground mb-3">Download a copy of all patient records and data</p>
                ...
                <div className="bg-card border border-border rounded-lg p-4">
                  ...
                  <p className="text-sm text-muted-foreground mb-3">Configure how long patient data is stored</p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-3 border-b border-border">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">Share anonymized data for research purposes</p>
                  </div>
                  <button className="relative inline-flex h-6 w-11 items-center rounded-full bg-muted">
                    <span className="inline-block h-4 w-4 transform rounded-full bg-white transition-transform translate-x-1" />
                  </button>
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-muted-foreground mb-2">Default Prescription Template</label>
                  <select className="w-full px-3 py-2 bg-input border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-ring text-foreground">
                ...
                <div>
                  <label className="block text-sm font-medium text-muted-foreground mb-2">AI Prescription Assistance</label>
                  <div className="flex items-center space-x-3">
                    <button className="relative inline-flex h-6 w-11 items-center rounded-full bg-primary">
                      <span className="inline-block h-4 w-4 transform rounded-full bg-white transition-transform translate-x-6" />
                    </button>
                    <span className="text-sm text-foreground">Enable AI-powered prescription suggestions</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <h3 className="text-lg font-semibold text-foreground mb-4">Clinical Settings</h3>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm font-medium text-muted-foreground mb-2">Appointment Duration</label>
                ...
                <div className="max-w-4xl">
                  ...
                  <div className="mt-8 pt-6 border-t border-border">
                    <div className="flex justify-end space-x-3">
                      ...
                      <button className="px-6 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors flex items-center space-x-2">
