...
A comprehensive **AI-powered healthcare management platform** built with **Next.js 15**, **MongoDB**, and **Google Gemini AI**. This modern web application provides doctors with an intuitive interface to manage patients, appointments, prescriptions, and### **Frontend Technologies**
